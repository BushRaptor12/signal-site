...
export const TERM_KNOWLEDGE = {
  ...
  female: ["woman", "women", "female politician", "female candidate", "woman politician", "kamala harris", "nikki haley", "nancy pelosi", "alexandria ocasio-cortez", "elizabeth warren"],
  finance: ["bank", "banks", "banking", "wall street", "stocks", "stock market", "markets", "investing"],
  google: ["alphabet", "search", "android", "ai"],
  "kamala harris": ["female politician", "woman politician", "vice president", "democrat", "democratic candidate"],
  ...
  woman: ["female", "women", "female politician", "woman politician", "female candidate", "kamala harris", "nikki haley", "nancy pelosi", "alexandria ocasio-cortez", "elizabeth warren"],
  women: ["woman", "female", "female politicians", "women politicians", "kamala harris", "nikki haley", "nancy pelosi", "alexandria ocasio-cortez", "elizabeth warren"],
