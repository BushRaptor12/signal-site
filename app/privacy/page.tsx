...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Information may be processed by service providers that help run the site, including Vercel for hosting and analytics and Supabase for application data and storage.",
